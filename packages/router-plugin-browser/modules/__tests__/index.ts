import { createRouter, constants, State } from '@riogz/router'
import browserPlugin from '../'
import browser from '../browser'
import { Browser, BrowserPluginOptions, HistoryState } from '../types'
...
const mockedBrowser: Browser = {
    ...browser,
    getBase: () => base,
    pushState: (state: HistoryState) => (currentHistoryState = state),
    replaceState: (state: HistoryState) => (currentHistoryState = state),
